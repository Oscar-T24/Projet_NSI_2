...
im1 = Image.open('images/7.jpg').convert('RGB')
...
def cache_image(im1,im2):
    ...
    for x in range(im1.width):
        for y in range(im1.height):
            ...
            pixel1 = [binR(r,5),binR(v,5),binR(b,5)] # on garde les 5 premiers bits de poids fort du pixel 1
            pixel2 = [binR(r2,3),binR(v2,3),binR(b2,3)] # o garde les 3 premiers bits de poids fort du pixel 2
